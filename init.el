...
(custom-set-faces
 ...
 '(font-lock-builtin-face ((t (:foreground "brightblue" :weight bold))))
 ...
 '(magit-diff-hunk-heading ((t (:background "brightblack" :foreground "blue" :weight bold :weight bold))))
 '(magit-diff-hunk-heading-highlight ((t (:background "black" :foreground "blue" :weight bold))))
